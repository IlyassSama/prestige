...
-- Prestige default scheme. Keep this block when using the example with a published copy of Library.lua.
Library.Scheme.BackgroundColor = Color3.fromRGB(11, 11, 14) -- #0b0b0e
Library.Scheme.MainColor = Color3.fromRGB(18, 18, 23) -- #121217
Library.Scheme.AccentColor = Color3.fromRGB(23, 102, 255)
Library.Scheme.AccentGradient = ColorSequence.new({
	ColorSequenceKeypoint.new(0, Color3.fromRGB(23, 102, 255)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(40, 226, 255)),
})
Library.Scheme.OutlineColor = Color3.fromRGB(35, 35, 41) -- #232329
Library.Scheme.FontColor = Color3.fromRGB(231, 231, 236) -- #e7e7ec
...
local Window = Library:CreateWindow({
	...
	Title = "Prestige",
	Footer = "Prestige | Example | -- ms | -- FPS | No key",
	Icon = 95816097006870,
	NotifySide = "Right",
