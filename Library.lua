...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(11, 11, 14), -- #0b0b0e
        MainColor = Color3.fromRGB(18, 18, 23), -- #121217
        AccentColor = Color3.fromRGB(23, 102, 255), -- royal blue from the Prestige logo
        AccentGradient = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(23, 102, 255)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(40, 226, 255)),
        }),
        OutlineColor = Color3.fromRGB(35, 35, 41), -- #232329
        FontColor = Color3.fromRGB(231, 231, 236), -- #e7e7ec
...
function Library:AddAccentGradient(Parent: GuiObject, Rotation: number?)
...
do
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        local Holder = New("Frame", {
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, Info.Compact and 18 or 38),
        ...
        local FillGradient = Library:AddAccentGradient(Fill, 0)
        ...
        function Slider:UpdateColors()
            ...
            Library.Registry[Knob].BackgroundColor3 = function()
                return Slider.Disabled and Library:GetDarkerColor(Library.Scheme.FontColor) or Library.Scheme.FontColor
            end
        end
    ...
    function Window:AddTab(...)
        ...
        do
            ...
            if TabButtonsStyle.Indicator then
                ...
                Library:AddAccentGradient(TabIndicator, 0)
            end
